      ...
      "contexts": [
        {
            "name": "q8s-0.dummy.com",
          "context": {
            "cluster": "q8s-0.dummy.com",
            "user": "q8s-0.dummy.com"
          }
        }
      ],
      "current-context": "q8s-0.dummy.com",
      "kind": "Config",
      "preferences": {},
      "users": [
        {
...
test "delete cluster" {
  let r1 = http.post("{api.url}/clusters");
  log(r1.body);

  expect.equal(dns.tryResolve("q8s-0.dummy.com"), "1.2.3.2");

  let r = http.delete("{api.url}/clusters/q8s-0.dummy.com");
...
test "get cluster" {
  ...
  let response = http.get("{api.url}/clusters/q8s-0.dummy.com");
